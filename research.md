...
within 3 to 6 month, but some can be expanded into full PhD project.
...
* <a href="javascript:void(0)" onclick="$('#{{project2}}').toggle();">Mozaik data-store module based on object oriented database</a>
    <small id="project2" style="display: none;">
        ...
        annotated with metadata regarding experimental context are stored. Currently the data-store module is ad-hoc implemented as a
        database-like system based on [Neo]() library for internal representation of recorded data. The goal of this project is to
        offer an alternative data-store module based around dedicated objective? database such as [] or [].     
    </small>
* <a href="javascript:void(0)" onclick="$('#{{project3}}').toggle();"></a>
